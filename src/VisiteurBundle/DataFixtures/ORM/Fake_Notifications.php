...
class Fake_Notifications implements FixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $notifs->setDatetime(\DateTime::createFromFormat("d/m/Y H:i","01/03/2017 15:00") );
        ...
        $notifs3->setDatetime(\DateTime::createFromFormat("d/m/Y H:i","01/03/2017 17:00") );
        ...
        $notifs4->setDatetime(\DateTime::createFromFormat("d/m/Y H:i","01/02/2017 11:00") );
        ...
        $notifs5->setDatetime(\DateTime::createFromFormat("d/m/Y H:i","01/02/2017 18:00") );
        ...
        $notifs6->setDatetime(\DateTime::createFromFormat("d/m/Y H:i","01/02/2017 20:00") );
